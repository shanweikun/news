...
@Slf4j
@Service
public class NewsColumnServiceImpl extends ServiceImpl<NewsColumnMapper,NewsColumnPO> implements NewsColumnService {
    ...
    public List<NewsColumnVO> getAllColumnsByParentId(Integer parentId) {
        LambdaQueryWrapper<NewsColumnPO> lambda = new QueryWrapper<NewsColumnPO>().lambda()
                .eq(parentId!=null,NewsColumnPO::getParentId,parentId)
                .orderByDesc(NewsColumnPO::getMenuOrder)
                .orderByDesc(NewsColumnPO::getCreateTime);
        List<NewsColumnPO> list = super.list(lambda);
...
//        newsColumnMapper.insert(newsColumnPO);
    ...
    public boolean updateNewsColumn(NewsColumnVO newsColumnVO) {
        ...
        NewsColumnPO newsColumnPO = new NewsColumnPO();
        newsColumnPO.setTitle(newsColumnVO.getTitle());
        newsColumnPO.setParentId(newParentId);
        newsColumnPO.setExternalLink(newsColumnVO.getExternalLink());
        newsColumnPO.setDescription(newsColumnVO.getDescription());
        newsColumnPO.setMenuOrder(newsColumnVO.getMenuOrder());
        newsColumnPO.setModuleOrder(newsColumnVO.getModuleOrder());
        //按照id更新栏目基本信息
